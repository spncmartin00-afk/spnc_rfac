    ...
    <Layout>
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="bg-white rounded-2xl p-8 space-y-10">
          ...
          <section className="space-y-6">
            <h2 className="text-3xl font-bold text-gray-800">Marketing & Promotional Opportunities</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-blue-50 p-6 rounded-lg">
                <h3 className="font-semibold text-xl mb-3">Newsletter Feature</h3>
                <p className="text-gray-700 mb-4">Opportunity to be featured in our monthly newsletter sent to our entire network of 2SLGBTQI+ seniors and allied organizations.</p>
                <a href="#" className="inline-block text-blue-600 font-semibold hover:text-blue-800">
                  Submit for Feature →
                </a>
              </div>
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                <h3 className="font-semibold text-xl mb-3">Social Media Promotion</h3>
                <p className="text-gray-700 mb-4">Get featured across our social media channels, reaching thousands of 2SLGBTQI+ seniors and community members.</p>
                <a href="#" className="inline-block text-blue-600 font-semibold hover:text-blue-800">
                  Request Promotion →
                </a>
              </div>
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                <h3 className="font-semibold text-xl mb-3">Event Co-Branding</h3>
                <p className="text-gray-700 mb-4">Partner with us on events and webinars, with co-branding opportunities to showcase your organization's expertise.</p>
                <a href="#" className="inline-block text-blue-600 font-semibold hover:text-blue-800">
                  Explore Co-Branding →
                </a>
              </div>
          ...
          <section className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-lg">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-lg mb-2">Certification Includes:</h4>
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                    <li>Official SPNC/RFAC certification badge</li>
                    <li>Digital marketing assets</li>
                    <li>Annual recognition ceremony invitation</li>
                    <li>Priority placement in our directory</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-semibold text-lg mb-2">Requirements:</h4>
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                    <li>Completion of cultural competency training</li>
                    <li>Implementation of inclusive policies</li>
                    <li>Staff diversity and inclusion training</li>
                    <li>Regular assessment and improvement</li>
                  </ul>
                </div>
              </div>
              <div className="mt-6">
